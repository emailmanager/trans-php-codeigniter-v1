...
|--------------------------------------------------------------------------
|
| Enter your Emailmanager API key here.
|
| This key is available by visiting your Emailmanager Rack, clicking 'Details'
...
|
| Configure your Sender Signatures at http://emailmanager.com/signatures
*/
$config['from_name'] = '';
$config['from_address'] = '';
...
|--------------------------------------------------------------------------
|
| Setting validation to TRUE will require that you pass Emailmanager valid
| email addresses for sender and reciever. If these are not valid email
| addresses, the request to send an email will not be sent to Emailmanager.
|
